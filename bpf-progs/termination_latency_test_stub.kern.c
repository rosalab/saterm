/*
 * BPF program for termination latency testing - stub mode
 * Attaches to: tracepoint/syscalls/sys_exit_saterm_test
 * 
 * For use on the stub-based termination branch.
 * Termination: bpftool prog terminate (stubs helpers externally)
 * 
